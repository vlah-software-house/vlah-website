...
export const socialMediaProfiles = [
  { title: 'Facebook', href: 'https://www.facebook.com/ShVlah', icon: FacebookIcon },
  { title: 'Instagram', href: 'https://www.instagram.com/shvlah/', icon: InstagramIcon },
  { title: 'Linkedin', href: 'https://www.linkedin.com/company/vlah-software-house/', icon: Linkedin },
]
